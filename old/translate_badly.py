# from https://github.com/prestevez/dna2proteins/blob/master/dna2proteins.py
# UPDATED 12 DEC 2023: edited for ciliate codon table
#
#
...
print(f'Seq frames: {sequences_frames}')
