...
def run_blastp_uniprot(db, query):
    output = query + ".uniprot.annotation"
...
if __name__ == "__main__":
    ...
    run_blastp_uniprot("/Users/jra/Dropbox/ciliates/old/uniprot/uniprot_sprot.fasta.db", args.fasta_file)
    annotate_swiss(args.fasta_file, args.fasta_file + ".uniprot.annotation")
